function Remove-PDKCard {
    ...
    $Error
    $PDKCardObject = Invoke-WebRequest -Method Delete -Uri $PDKCardEndpoint -Headers $Headers -ContentType "application/json" -UseBasicParsing -ErrorAction SilentlyContinue
